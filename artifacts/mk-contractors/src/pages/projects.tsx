...
export default function Projects() {
  ...
  const projects = [
    ...
    { id: 5, caption: "Data Center Utility Excavation — Lehigh County, PA", category: "Utilities" },
    { id: 6, caption: "Gravel Driveway & Stormwater Management — Philadelphia Metro", category: "Site Development" },
